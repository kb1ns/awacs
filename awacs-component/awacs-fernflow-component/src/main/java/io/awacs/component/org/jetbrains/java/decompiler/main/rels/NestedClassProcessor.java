 ...
 */
package io.awacs.component.org.jetbrains.java.decompiler.main.rels;
...
import io.awacs.component.org.jetbrains.java.decompiler.main.collectors.CounterContainer;
import io.awacs.component.org.jetbrains.java.decompiler.main.collectors.VarNamesCollector;
...
import io.awacs.component.org.jetbrains.java.decompiler.modules.decompiler.stats.DoStatement;
import io.awacs.component.org.jetbrains.java.decompiler.modules.decompiler.stats.RootStatement;
...
import io.awacs.component.org.jetbrains.java.decompiler.struct.StructField;
import io.awacs.component.org.jetbrains.java.decompiler.struct.StructMethod;
import io.awacs.component.org.jetbrains.java.decompiler.struct.attr.StructEnclosingMethodAttribute;
...
import io.awacs.component.org.jetbrains.java.decompiler.modules.decompiler.exps.*;
import io.awacs.component.org.jetbrains.java.decompiler.modules.decompiler.sforms.DirectGraph;
import io.awacs.component.org.jetbrains.java.decompiler.modules.decompiler.sforms.DirectNode;
...
public class NestedClassProcessor {
  ...
  public void processClass(ClassesProcessor.ClassNode root, ClassesProcessor.ClassNode node) {
    ...
    for (ClassesProcessor.ClassNode child : node.nested) {
      ...
      else if (child.type == ClassesProcessor.ClassNode.CLASS_ANONYMOUS && (child.access & CodeConstants.ACC_SYNTHETIC) != 0 || cl.isSynthetic()) {
        child.namelessConstructorStub = !cl.hasModifier(CodeConstants.ACC_STATIC) && cl.getMethods().size() + cl.getFields().size() == 0;
      }
    }
  ...
  private static void computeLocalVarsAndDefinitions(final ClassesProcessor.ClassNode node) {
    ...
    for (Entry<String, Map<String, List<VarFieldPair>>> enclosing : mapVarMasks.entrySet()) {
      ...
      for (Entry<String, List<VarFieldPair>> entry : enclosing.getValue().entrySet()) {
        ...
        boolean firstSignField = nestedNode.type != ClassesProcessor.ClassNode.CLASS_ANONYMOUS;
